...
var mnist_loader=(function(){
	...
	function load_imgData(img){
		...
		for (var line=0, targetData; line<3000; line++){
			...
			if (_dataCounter>=60000){
				return false; //stop loading
			} else if (_dataCounter<50000){ //first fill training data
	...
	return {
		load_data_wrapper: function(callback){
			/*
